...
, RoleBasedPolicy = authorizator.RoleBasedPolicy;
...
authorizator.use(RoleBasedPolicy);

// We add two roles
var user = authorizator.addRole('user');
var admin = authorizator.addRole('admin');
// we say what is minimum priority to execute this action, 
// and we specify priority order of roles
authorizator.addAction('view account').minRole(admin).rolePriority(admin, user);
